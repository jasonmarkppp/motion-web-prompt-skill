...
> analytics platform with live chart previews and clean data viz

**Category:** SaaS · **Tags:** Analytics, Dashboard, Blue

---

Create a premium animated analytics SaaS landing page for "Datacore" — analytics platform with live chart previews and clean data viz.
...
## Design direction
- Mood: analytical, clear, professional
- Palette: background #F8FAFC, surface #FFFFFF, primary #0EA5E9, accent #0284C7, text #0F172A
- Layout: split hero: copy left, animated chart right, metric cards row
- Motion: chart bars grow on scroll (height 0→target), numbers count up
...
## Hero requirements
- Headline: "See what your data is trying to tell you"
- Subhead: "Datacore turns messy pipelines into dashboards your whole team understands."
- Primary CTA: "Start analyzing" | Secondary: "View demo"
- Animated bar/line chart component in hero
...
## Typography
- Display: Inter 52/60 weight 700
- Body: Inter 16
