...
> refracted light aesthetic with glass panels and spectrum accents

**Category:** Landing Page · **Tags:** Glassmorphism, Creative, Colorful

---

Create a premium animated creative agency landing page for "Prism" — refracted light aesthetic with glass panels and spectrum accents.

## Stack
- React 19 + Vite + TypeScript + Tailwind CSS 4 + motion (Framer Motion v12+)
- Google Fonts: Syne (display) + Work Sans (body)
- Icons: lucide-react

## Design direction
- Mood: creative studio, bold, chromatic
- Palette: background #0F0F12, surface rgba(255,255,255,0.08), primary #22D3EE, accent #F472B6, text #FAFAFA
- Layout: diagonal section dividers, glass cards with rainbow border gradient on hover
- Motion: border gradient rotates 360deg over 8s on featured card
...
## Hero requirements
- Headline: "We bend light into brands"
- Subhead: "Prism Studio crafts identities that shimmer across every touchpoint."
- Primary CTA: "See our work" | Secondary: "View demo"
- Glass card stack with iridescent border
