...
> startup growth platform with rocket motif and playful illustrations

**Category:** SaaS · **Tags:** Startup, Growth, Rocket

---

Create a premium animated startup SaaS landing page for "Platform Rocket" — startup growth platform with rocket motif and playful illustrations.

## Stack
- React 19 + Vite + TypeScript + Tailwind CSS 4 + motion (Framer Motion v12+)
- Google Fonts: Nunito (display) + Open Sans (body)
- Icons: lucide-react

## Design direction
- Mood: playful, growth-focused, startup energy
- Palette: background #F0F4FF, surface #FFFFFF, primary #4F46E5, accent #F43F5E, text #1E1B4B
- Layout: illustrated hero with rocket SVG, growth chart section, pricing cards
- Motion: rocket SVG translates Y with parallax on scroll, stars twinkle
...
## Hero requirements
- Headline: "Launch your platform into orbit"
- Subhead: "Platform Rocket helps startups go from MVP to market leader in record time."
- Primary CTA: "Ignite launch" | Secondary: "View demo"
- Custom SVG rocket with indigo body and rose flame trail
