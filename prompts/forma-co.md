...
> Swiss-inspired design tool landing with bento grid features

**Category:** Landing Page · **Tags:** Design, Minimal, Bento

---

Create a premium animated landing page for "Forma" — Swiss-inspired design tool landing with bento grid features.

## Stack
- React 19 + Vite + TypeScript + Tailwind CSS 4 + motion (Framer Motion v12+)
- Google Fonts: Neue Montreal or Inter Tight (display) + Inter (body)
- Icons: lucide-react

## Design direction
- Mood: calm, precise, gallery-quality
- Palette: background #F5F3EF, surface #FFFFFF, primary #111111, accent #C8B89A, text #111111
- Layout: bento grid feature section, thin 1px borders, large negative space
- Motion: magnetic cursor on primary button, cards lift 4px on hover
...
## Hero requirements
- Headline: "Shape ideas into systems"
- Subhead: "Forma connects research, wireframes, and handoff in one calm workspace."
- Primary CTA: "Request access" | Secondary: "View demo"
- Bento preview grid of UI panels with 1px #E5E5E5 borders
...
## Typography
- Display: Inter Tight 52/58 weight 600
- Body: Inter 15/24
