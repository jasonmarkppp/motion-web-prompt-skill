...
> high-voltage dark tech with cyan-violet neon accents

**Category:** Landing Page · **Tags:** Dark, Neon, Tech

---

Create a premium animated landing page for "Electric" — high-voltage dark tech with cyan-violet neon accents.
...
## Design direction
- Mood: futuristic, sharp, developer-forward
- Palette: background #050508, surface #0D0D14, primary #00F0FF, accent #7C3AED, text #F0F0F5
- Layout: centered hero with grid background, neon border cards, monospace accents
- Motion: electric pulse on CTA border, scanline overlay at 3% opacity, text glitch on hover (subtle)
...
## Hero requirements
- Headline: "Ship at the speed of thought"
- Subhead: "Electric is the infra layer for teams who refuse to slow down."
- Primary CTA: "Deploy now" | Secondary: "View demo"
- Animated SVG circuit lines converging to center glow
...
- Hero grid lines animate opacity 0.3→0.6 on scroll

## Typography
- Display: Space Grotesk 64/72, uppercase tracking -0.03em
- Body: Inter 16
