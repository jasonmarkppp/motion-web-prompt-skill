...
> real-time analytics with glowing data visualization

**Category:** SaaS · **Tags:** Analytics, Purple, Modern

---

Create a premium animated analytics platform landing page for "Pulse Analytics" — real-time analytics with glowing data visualization.
...
## Design direction
- Mood: real-time, energetic, data-forward
- Palette: background #0C0A14, surface #15121F, primary #A855F7, accent #22D3EE, text #F4F4F5
- Layout: full-width live metrics ticker, dark cards with glow borders
- Motion: live pulse dot on 'real-time' badge, metric numbers update every 3s
...
## Hero requirements
- Headline: "Metrics that move as fast as you do"
- Subhead: "Pulse streams live analytics with sub-second latency and zero config."
- Primary CTA: "Start streaming" | Secondary: "View demo"
- Glowing line chart with cyan/purple gradient stroke
