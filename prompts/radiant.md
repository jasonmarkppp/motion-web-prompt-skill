...
> warm, confident product storytelling with soft sunrise gradients

**Category:** Landing Page · **Tags:** SaaS, Light, Gradient

---

Create a premium animated landing page for "Radiant" — warm, confident product storytelling with soft sunrise gradients.
...
## Design direction
- Mood: optimistic, editorial, premium consumer SaaS
- Palette: background #FAFAF8, surface #FFFFFF, primary #E85D3B, accent #F4A261, text #1A1A1A
- Layout: asymmetric hero with large serif headline left, product mock right, generous whitespace
- Motion: gentle float on hero visual, gradient mesh slowly shifts (CSS keyframes 20s)
...
## Hero requirements
- Headline: "Design that feels human again"
- Subhead: "Radiant helps teams ship interfaces people actually enjoy using."
- Primary CTA: "Start free" | Secondary: "View demo"
- Floating browser mock with soft shadow and subtle tilt on mouse move (max 6deg)
...
## Typography
- Display: Instrument Serif 56/64 desktop, 36/42 mobile
- Body: DM Sans 16/18
