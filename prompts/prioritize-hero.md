...
> 采用极浅灰背景，顶部导航栏与全屏英雄区结合，使用Inter字体与Caveat手写体点缀，品牌图标为阶梯式积木SVG，搭配Framer Motion动画与lucide-react图标，打造简洁现代的产品展示页。

**Category:** Hero Section · **Type:** hero · **Platform:** website
